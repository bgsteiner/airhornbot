...
```
go get github.com/bgsteiner/airhornbot/cmd/bot
go install github.com/bgsteiner/airhornbot/cmd/bot
```
...
First install the webserver: `go install github.com/bgsteiner/airhornbot`, then run `make static`, finally run:
